    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 sm:px-5 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl shadow-sm transition-all flex items-center justify-center gap-2 self-stretch sm:self-auto cursor-pointer"
        >
      ...
      <div className="md:hidden space-y-3.5">
        {filteredProperties.length === 0 ? (
          ...
          filteredProperties.map((property) => {
            ...
            return (
              <div key={property.id} className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs space-y-3">
                <div className="flex gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-xs font-bold font-serif text-amber-700 mt-0.5">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
                  ...
                  <select
                    ...
                    className={`px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border cursor-pointer ${
                  ...
                  <div className="flex items-center gap-1">
                    {isSuperadmin && property.status === 'draft' && (
                      <button
                        ...
                        className="p-2 bg-emerald-100 text-emerald-800 rounded-lg text-xs"
                        title="Approve"
                      >
